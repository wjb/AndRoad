...
public class CloudmadeLUSRequester implements Constants, LUSRequester {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public ArrayList<GeocodedAddress> requestReverseGeocode(final Context ctx, final GeoPoint aGeoPoint, final ReverseGeocodePreferenceType aPreferenceType) throws MalformedURLException, IOException, SAXException, ORSException{
		...
		return request(ctx, CloudmadeLUSRequestComposer.reverseGeocode(aGeoPoint));
	}
	...
	public ArrayList<GeocodedAddress> requestFreeformAddress(final Context ctx, final Country nat, final String freeFormAddress) throws MalformedURLException, IOException, SAXException, ORSException{
		return request(ctx, CloudmadeLUSRequestComposer.createFreeformAddressRequest(nat, freeFormAddress));
	}
	...
	public ArrayList<GeocodedAddress> requestStreetaddressCity(final Context ctx, final Country nat, final ICountrySubdivision pCountrySubdivision, final String pCity, final String pStreetName, final String pStreetNumber) throws MalformedURLException, IOException, SAXException, ORSException{
		if(shouldDoWorkaround(nat)) {
			return request(ctx, CloudmadeLUSRequestComposer.createFreeformAddressRequest(nat, structuredToFreeform(pCountrySubdivision, pCity, pStreetName, pStreetNumber)));
		} else {
			return request(ctx, CloudmadeLUSRequestComposer.createStreetaddressCityRequest(nat, pCountrySubdivision, pCity, pStreetName, pStreetNumber));
		}
	}
	...
	public ArrayList<GeocodedAddress> requestStreetaddressPostalcode(final Context ctx, final Country nat, final ICountrySubdivision pCountrySubdivision, final String pPostalCode, final String pStreetName, final String pStreetNumber) throws MalformedURLException, IOException, SAXException, ORSException{
		if(shouldDoWorkaround(nat)) {
			return request(ctx, CloudmadeLUSRequestComposer.createFreeformAddressRequest(nat, structuredToFreeform(pCountrySubdivision, pPostalCode, pStreetName, pStreetNumber)));
		} else {
			return request(ctx, CloudmadeLUSRequestComposer.createStreetaddressPostalcodeRequest(nat, pCountrySubdivision, pPostalCode, pStreetName, pStreetNumber));
		}
	}
	...
	private ArrayList<GeocodedAddress> request(final Context ctx, final String locationRequest) throws SAXException, ORSException, IOException{
        CloudmadeUtil.retrieveCloudmadeKey(ctx.getApplicationContext());

        final String cloudmadeurl = "http://geocoding.cloudmade.com/" + CloudmadeUtil.getCloudmadeKey() + "/geocoding/v2/find.plist?" + locationRequest;
		...
		final DefaultHandler openLUSParser = new CloudmadeLUSParser();
        ...
        return ((CloudmadeLUSParser)openLUSParser).getAddresses();
	}
